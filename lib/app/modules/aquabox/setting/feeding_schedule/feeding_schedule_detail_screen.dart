...
class _FeedingScheduleDetailScreenState
  ...
  final _history = <FeedHistory>[
    FeedHistory(DateTime.now().subtract(const Duration(hours: 2)),
        'Bể 1', 12.0),
            ...
            children: [
                ...
                child: Row(
                  children: [
                    const Text('Khối lượng mỗi lần: ',
                        style: TextStyle(fontSize: 15)), const Spacer(),
                    IconButton(
                  ...
                  child: DataTable(
                    ...
                    columns: const [
                      ...
                      DataColumn(
                          numeric: true,
                          label:
                              Text('Khối lượng (kg)', style: _headerStyle)),
                    ],
                    rows: _ingredients
              ...
              Container(
                ...
                child: SizedBox(
                  ...
                  child: DataTable(
                    headingRowColor:
                        MaterialStateProperty.all(CustomColors.appbarColor),
                    dataRowColor: MaterialStateProperty.all(
                        Colors.grey.shade200),
                    columnSpacing: 24,
                    columns: const [
                      ...
                      DataColumn(
                          label: Text('Bể', style: _headerStyle)),
                      DataColumn(
                          numeric: true,
                          label:
                              Text('Khối lượng (kg)', style: _headerStyle)),
