...
class _FeedReportScreenState extends State<FeedReportScreen> {
  ...
  void initState() {
    super.initState();
    _currentFoodTypes = widget.isAquatic ? _foodTypes['aquatic']! : _foodTypes['animal']!;
  ...
  List<_PieData> get _pie {
    final Map<String, double> totalFoodQuantities = {for (var food in _currentFoodTypes) food: 0.0};
    ...
    return totalFoodQuantities.entries.map((e) => _PieData(e.key, e.value)).toList();
  }
