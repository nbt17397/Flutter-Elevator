...
class CustomColors {
  ...
  static Color appbarColor = Color.fromARGB(255, 16, 39, 78);

  static Color subColor = Color(0xff003CA1);
}
...
List<Color> gradientColors = [Colors.yellow.shade500, activeColor2];

List<Color> gradientPHColors = [
  Color.fromARGB(255, 70, 124, 102),
  Colors.purpleAccent
];
